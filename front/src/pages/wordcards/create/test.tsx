...
import InputDisplayBoxTest from '@/components/InputDisplayBoxTest';
...
const AddPage: NextPage = () => {
  ...
  // 入力値のインデックス管理・カウンターを使用することでインデックスの重複を防ぐ
  ...
  return (
    ...
    >
      <Container maxWidth="md" sx={{ pt: 6, pb: 6 }}>
        ...
        <Button onClick={() => console.log(inputValues)}>inputvalues</Button>
        <Button onClick={() => deleteInputValue(2)}>delete</Button>
      </Container>
